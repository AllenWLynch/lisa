...
def main(species, motif_bed, window_size, gamma_threshold = 0.95):
    ...
    return hits.indices, hits.data, factor_name
...
if __name__ == "__main__":
    ...
    hit_indices, scores, factor_name = main(args.species, args.motif_bed, args.window_size)
    ...
    with open(args.output, 'w') as f:
        for idx, score in zip(hit_indices, scores):
            print(motif_id, idx, score, file = f)